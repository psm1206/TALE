...
class HyperTuning(object):
    ...
    def trial(self, params):
        ...
        if self.dataset is None:
            result_dict, dataset = self.objective_function(config_dict, self.fixed_config_file_list)
            self.dataset = dataset
        else: 
            result_dict, _ = self.objective_function(config_dict, self.fixed_config_file_list, dataset = self.dataset)
